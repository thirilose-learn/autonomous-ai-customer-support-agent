"""
Applies migration 20260910130000_add_contact_to_support_escalations.sql to Supabase PostgreSQL.
Verifies contact columns in support_escalations and checks that Level 3 & Level 4 tables are 100% preserved.
"""
...
with open("supabase/migrations/20260910130000_add_contact_to_support_escalations.sql", "r", encoding="utf-8") as f:
    sql = f.read()
...
print("Applying contact fields migration to support_escalations...")
cur.execute(sql)
