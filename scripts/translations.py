"""
Official standard Olist Portuguese-to-English product category translations.
Maps all 73 distinct categories present in products_dataset.csv.
"""
...
CATEGORY_TRANSLATIONS = {
    ...
    "pet_shop": "pet_shop",
    "portateis_casa_forno_e_cafe": "portables_home_oven_and_coffee",
...
def translate_category(pt_category: str) -> str:
    """Translates a Portuguese product category to English, or returns original if not found."""
    if not pt_category:
        return ""
    cleaned = pt_category.strip().lower()
    return CATEGORY_TRANSLATIONS.get(cleaned, cleaned)
